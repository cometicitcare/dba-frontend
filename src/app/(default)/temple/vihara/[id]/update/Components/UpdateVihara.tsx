            ...
            <div className="bg-white shadow-xl overflow-hidden">
              <div className="bg-gradient-to-r from-slate-700 to-slate-800 px-6 md:px-10 py-6">
                <div className="flex items-center justify-between gap-4">
                  <div>
                    <h1 className="text-2xl font-bold text-white mb-1">Update Temple Registration</h1>
                    <p className="text-slate-300 text-sm">Please update the required information</p>
                  </div>
                </div>
              </div>
