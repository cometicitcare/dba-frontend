...
export function validateField<T>(field: FieldConfig<T>, value: string | undefined, all: Partial<T>, today: string): string {
  ...
  if (rules.required) {
    ...
    if (fieldName.includes("certified") || fieldName.includes("_deed") || fieldName.includes("recommend_") || fieldName.includes("annex2_") || fieldName.includes("secretary_") || fieldName.includes("pooja_") || fieldName.includes("institution_")) {
