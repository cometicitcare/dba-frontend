...
type Props = {
  ...
  onAddArama?: (result: { name?: string; trn?: string; display?: string; data?: any }) => Promise<void> | void;
};

export default function AramaAutocompleteAddress({
  id,
  label,
  placeholder,
  required,
            ...
            <form
              onSubmit={async (event: FormEvent<HTMLFormElement>) => {
                ...
                try {
                  ...
                  const addressOption = created?.ta_address ?? newAddress.trim();
                  ...
                  onPick({
                    ...
                    display: `${displayName}${addressOption ? ` - ${addressOption}` : ""}`,
                    name: displayName,
                    trn: createdTrn,
                  });
