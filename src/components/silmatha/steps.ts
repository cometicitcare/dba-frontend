...
export const silmathaSteps: StepConfig<SilmathaForm>[] = [
  ...
  },
  {
    ...
    fields: [
      ...
      { name: "sm_divisional_secretariat", label: "Divisional Secretariat", type: "text", rules: { required: true } },
      { name: "sm_gn_division", label: "GN Division", type: "text", rules: { required: true } },
      { name: "sm_korale", label: "Korale", type: "text", rules: { required: true } },
      { name: "sm_pattu", label: "Pattu", type: "text", rules: { required: true } },
      { name: "sm_village", label: "Village", type: "text", rules: { required: true } },
    ],
  },
  {
    id: 3,
