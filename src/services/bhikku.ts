...
export const _approveHighBhikkhu = (br_regn: any) => BackendClient.post(`${baseURL}/bhikkus/${br_regn}/approve`);
export const _rejectHighBhikkhu = (br_regn: any, body: any) => BackendClient.post(`${baseURL}/bhikkus/${br_regn}/reject`, body);
export const _markPrintedHighBhikkhu = (br_regn: any) => BackendClient.post(`${baseURL}/bhikkus/${br_regn}/mark-printed`);
export const _uploadScannedHighDocument = (br_regn: any, file: File) => {
  const formData = new FormData();
  formData.append("file", file);
  return BackendClient.post(
    `${baseURL}/bhikkus/${br_regn}/upload-scanned-document`,
